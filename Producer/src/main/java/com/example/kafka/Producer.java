...
public class Producer
{
    ...
    {
        ProducerRecord<String, String> record = new ProducerRecord<>(TopicName, 0, null, Message);
        int i=0;
        while(i<1) {
